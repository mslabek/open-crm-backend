 ...
 * dto does not contain {@link Category categories} it belongs to, but is may be contained within
 * {@link CategoryParentDto}.
 *
 * @see InventoryParentDto
 */
@Getter
@AllArgsConstructor
public class InventoryChildDto {
